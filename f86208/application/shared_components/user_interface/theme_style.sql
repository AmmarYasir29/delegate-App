...
wwv_flow_imp_shared.create_theme_style(
 p_id=>wwv_flow_imp.id(10634571652604036980)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_theme_style(
 p_id=>wwv_flow_imp.id(10634571902796036981)
,p_theme_id=>42
,p_name=>'Vita'
,p_is_current=>true
,p_is_public=>true
...
wwv_flow_imp_shared.create_theme_style(
 p_id=>wwv_flow_imp.id(10634572078201036981)
,p_theme_id=>42
,p_name=>'Vita - Dark'
,p_is_current=>false
,p_is_public=>true
...
wwv_flow_imp_shared.create_theme_style(
 p_id=>wwv_flow_imp.id(10634572325332036981)
,p_theme_id=>42
,p_name=>'Vita - Red'
,p_is_current=>false
,p_is_public=>true
...
wwv_flow_imp_shared.create_theme_style(
 p_id=>wwv_flow_imp.id(10634572500060036981)
,p_theme_id=>42
,p_name=>'Vita - Slate'
,p_is_current=>false
,p_is_public=>true
