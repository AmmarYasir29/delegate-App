...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(10634407143386036508)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634407382027036537)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634407691311036544)
,p_page_template_id=>wwv_flow_imp.id(10634407143386036508)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634407975045036545)
,p_page_template_id=>wwv_flow_imp.id(10634407143386036508)
