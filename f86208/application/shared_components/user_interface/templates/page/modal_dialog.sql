...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(10634427359491036625)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634427728584036626)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634428033226036626)
,p_page_template_id=>wwv_flow_imp.id(10634427359491036625)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634428317736036630)
,p_page_template_id=>wwv_flow_imp.id(10634427359491036625)
