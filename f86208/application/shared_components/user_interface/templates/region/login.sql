...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10634494575536036814)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634494882011036814)
,p_plug_template_id=>wwv_flow_imp.id(10634494575536036814)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634495224682036815)
,p_plug_template_id=>wwv_flow_imp.id(10634494575536036814)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634495518934036815)
,p_plug_template_id=>wwv_flow_imp.id(10634494575536036814)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634495767252036815)
,p_plug_template_id=>wwv_flow_imp.id(10634494575536036814)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634496094706036815)
,p_plug_template_id=>wwv_flow_imp.id(10634494575536036814)
,p_name=>'Sub Regions'
