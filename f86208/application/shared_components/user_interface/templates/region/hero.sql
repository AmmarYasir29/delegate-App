...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10634474966622036778)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634475322821036778)
,p_plug_template_id=>wwv_flow_imp.id(10634474966622036778)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634475576259036780)
,p_plug_template_id=>wwv_flow_imp.id(10634474966622036778)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634475884562036780)
,p_plug_template_id=>wwv_flow_imp.id(10634474966622036778)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634476195798036780)
,p_plug_template_id=>wwv_flow_imp.id(10634474966622036778)
,p_name=>'Sub Regions'
