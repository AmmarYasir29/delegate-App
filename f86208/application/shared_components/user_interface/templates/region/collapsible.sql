...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10634461258515036733)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634461569869036733)
,p_plug_template_id=>wwv_flow_imp.id(10634461258515036733)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634461875462036733)
,p_plug_template_id=>wwv_flow_imp.id(10634461258515036733)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634462209481036733)
,p_plug_template_id=>wwv_flow_imp.id(10634461258515036733)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634462459600036734)
,p_plug_template_id=>wwv_flow_imp.id(10634461258515036733)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634462805117036734)
,p_plug_template_id=>wwv_flow_imp.id(10634461258515036733)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634463103948036734)
,p_plug_template_id=>wwv_flow_imp.id(10634461258515036733)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634463419712036737)
,p_plug_template_id=>wwv_flow_imp.id(10634461258515036733)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634463705442036737)
,p_plug_template_id=>wwv_flow_imp.id(10634461258515036733)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634464005485036737)
,p_plug_template_id=>wwv_flow_imp.id(10634461258515036733)
,p_name=>'Sub Regions'
