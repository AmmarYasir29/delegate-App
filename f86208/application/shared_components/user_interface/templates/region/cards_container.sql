...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10634449757878036698)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634450090192036698)
,p_plug_template_id=>wwv_flow_imp.id(10634449757878036698)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634450414249036700)
,p_plug_template_id=>wwv_flow_imp.id(10634449757878036698)
,p_name=>'Sub Regions'
