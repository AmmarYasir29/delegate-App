...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10634482795722036792)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634483065359036792)
,p_plug_template_id=>wwv_flow_imp.id(10634482795722036792)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634483351465036792)
,p_plug_template_id=>wwv_flow_imp.id(10634482795722036792)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634483691842036794)
,p_plug_template_id=>wwv_flow_imp.id(10634482795722036792)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634483959436036794)
,p_plug_template_id=>wwv_flow_imp.id(10634482795722036792)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634484272910036794)
,p_plug_template_id=>wwv_flow_imp.id(10634482795722036792)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634484585433036794)
,p_plug_template_id=>wwv_flow_imp.id(10634482795722036792)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634484901721036794)
,p_plug_template_id=>wwv_flow_imp.id(10634482795722036792)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634485186530036795)
,p_plug_template_id=>wwv_flow_imp.id(10634482795722036792)
,p_name=>'Sub Regions'
