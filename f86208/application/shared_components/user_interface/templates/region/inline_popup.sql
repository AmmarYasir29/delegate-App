...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10634487443262036798)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634487735106036798)
,p_plug_template_id=>wwv_flow_imp.id(10634487443262036798)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634488017662036798)
,p_plug_template_id=>wwv_flow_imp.id(10634487443262036798)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634488310303036800)
,p_plug_template_id=>wwv_flow_imp.id(10634487443262036798)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634488630574036800)
,p_plug_template_id=>wwv_flow_imp.id(10634487443262036798)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634488858063036800)
,p_plug_template_id=>wwv_flow_imp.id(10634487443262036798)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634489219205036800)
,p_plug_template_id=>wwv_flow_imp.id(10634487443262036798)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634489520138036801)
,p_plug_template_id=>wwv_flow_imp.id(10634487443262036798)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634489810103036801)
,p_plug_template_id=>wwv_flow_imp.id(10634487443262036798)
,p_name=>'Sub Regions'
