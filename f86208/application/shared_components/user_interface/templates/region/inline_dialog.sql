...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10634478233530036784)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634478499289036784)
,p_plug_template_id=>wwv_flow_imp.id(10634478233530036784)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634478840516036786)
,p_plug_template_id=>wwv_flow_imp.id(10634478233530036784)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634479125188036786)
,p_plug_template_id=>wwv_flow_imp.id(10634478233530036784)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634479385988036787)
,p_plug_template_id=>wwv_flow_imp.id(10634478233530036784)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634479709049036787)
,p_plug_template_id=>wwv_flow_imp.id(10634478233530036784)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634480029032036787)
,p_plug_template_id=>wwv_flow_imp.id(10634478233530036784)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634480292920036789)
,p_plug_template_id=>wwv_flow_imp.id(10634478233530036784)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634480586192036789)
,p_plug_template_id=>wwv_flow_imp.id(10634478233530036784)
,p_name=>'Sub Regions'
