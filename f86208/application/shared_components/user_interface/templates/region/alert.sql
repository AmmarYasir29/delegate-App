...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10634437466339036661)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634437812293036670)
,p_plug_template_id=>wwv_flow_imp.id(10634437466339036661)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634438098305036672)
,p_plug_template_id=>wwv_flow_imp.id(10634437466339036661)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634438376830036672)
,p_plug_template_id=>wwv_flow_imp.id(10634437466339036661)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634438727720036672)
,p_plug_template_id=>wwv_flow_imp.id(10634437466339036661)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634438996973036673)
,p_plug_template_id=>wwv_flow_imp.id(10634437466339036661)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634439283085036673)
,p_plug_template_id=>wwv_flow_imp.id(10634437466339036661)
,p_name=>'Sub Regions'
