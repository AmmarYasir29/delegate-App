...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10634506619782036840)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634506881098036840)
,p_plug_template_id=>wwv_flow_imp.id(10634506619782036840)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634507183317036840)
,p_plug_template_id=>wwv_flow_imp.id(10634506619782036840)
,p_name=>'Tabs'
