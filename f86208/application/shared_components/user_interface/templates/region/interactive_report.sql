...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10634492749137036809)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634493077391036809)
,p_plug_template_id=>wwv_flow_imp.id(10634492749137036809)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634493382324036811)
,p_plug_template_id=>wwv_flow_imp.id(10634492749137036809)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634493654483036811)
,p_plug_template_id=>wwv_flow_imp.id(10634492749137036809)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634493961824036812)
,p_plug_template_id=>wwv_flow_imp.id(10634492749137036809)
,p_name=>'Sub Regions'
