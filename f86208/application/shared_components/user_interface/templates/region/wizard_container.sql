...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10634514015751036848)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634514341656036848)
,p_plug_template_id=>wwv_flow_imp.id(10634514015751036848)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634514555264036850)
,p_plug_template_id=>wwv_flow_imp.id(10634514015751036848)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634514943205036850)
,p_plug_template_id=>wwv_flow_imp.id(10634514015751036848)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634515241116036850)
,p_plug_template_id=>wwv_flow_imp.id(10634514015751036848)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634515460949036850)
,p_plug_template_id=>wwv_flow_imp.id(10634514015751036848)
